<div id="page-container">
    ...
    <nav id="page-leftbar" role="navigation">
        ...
        <ul class="acc-menu" id="sidebar">
            ...
            <li><a href="javascript:;"><i class="icon-list-ol"></i> <span>UI Elements</span> <span
                            class="badge badge-indigo">4</span></a>
                <ul class='acc-menu'>
            ...
            <li><a href="javascript:;"><i class="icon-tasks"></i> <span>UI Componenets</span> <span
            ...
            <li><a href="javascript:;"><i class="icon-pencil"></i> <span>Advanced Forms</span><span
            ...
            <li><a href="javascript:;"><i class="icon-flag"></i> <span>Icons</span> <span
                            class="badge badge-orange">2</span></a>
                <ul class="acc-menu">
            ...
            <li class="divider"></li>
            <li><a href="javascript:;"><i class="icon-briefcase"></i> <span>Extras</span> <span
