...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $category = [
            ...
            ['id' => 52, 'category' => 'Penyimpanan Makanan', 'type' => 'child', 'child_id' => '51', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 53, 'category' => 'Peralatan Dapur', 'type' => 'child', 'child_id' => '51', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 54, 'category' => 'Pisau', 'type' => 'child', 'child_id' => '51', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 55, 'category' => 'Food & Drink Maker', 'type' => 'child', 'child_id' => '51', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 56, 'category' => 'Peralatan Makan', 'type' => 'child', 'child_id' => '51', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 57, 'category' => 'Bekal', 'type' => 'child', 'child_id' => '51', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 58, 'category' => 'Handphone & Tablet', 'type' => 'main', 'child_id' => '', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 59, 'category' => 'Smartphone', 'type' => 'child', 'child_id' => '58', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 60, 'category' => 'Tablet', 'type' => 'child', 'child_id' => '58', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 61, 'category' => 'Fliphone', 'type' => 'child', 'child_id' => '58', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 62, 'category' => 'Kamera', 'type' => 'main', 'child_id' => '', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 63, 'category' => 'Lensa & Aksesoris', 'type' => 'child', 'child_id' => '62', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 64, 'category' => 'Flash & Aksesoris', 'type' => 'child', 'child_id' => '62', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 65, 'category' => 'Batterai , Charge & Grip', 'type' => 'child', 'child_id' => '62', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 66, 'category' => 'Aksesoris', 'type' => 'child', 'child_id' => '62', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 67, 'category' => 'Roll Film', 'type' => 'child', 'child_id' => '62', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 68, 'category' => 'Frame & Album', 'type' => 'child', 'child_id' => '62', 'created_at' => \Carbon\Carbon::now()],
        ];
